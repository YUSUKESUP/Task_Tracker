...
abstract class $MemoCopyWith<$Res> {
  ...
  @useResult
  $Res call({String text, DateTime createdAt, bool isDone});
}
...
class _$_Memo implements _Memo {
  const _$_Memo(
      {required this.text, required this.createdAt, required this.isDone});
  ...
  @override
  String toString() {
    return 'Memo(text: $text, createdAt: $createdAt, isDone: $isDone)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, text, createdAt, isDone);
...
abstract class _Memo implements Memo {
  const factory _Memo(
      ...
      required final bool isDone}) = _$_Memo;
